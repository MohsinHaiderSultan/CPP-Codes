...
struct record
{
    string pasanger_name,Flight_name,seat_num,nplate,root;
    int price;
...
int t=0;
    ...
    for(int i=0;i<50;i++)
    {
        if(cat==al[i].seat_num)
        {
            ...
            cout<<" Enter pasanger name is:"<<al[i].pasanger_name<<endl;
...
void fulldisplay()
{
    ...
    for(int i=0;i<count;i++)
    {
            ...
            cout<<" pasanger_name is:"<<al[i].pasanger_name<<endl;
...
int t=0;
    ...
    for(int i=0;i<50;i++)
    {
        if(cat==al[i].pasanger_name)
        {
            t++;
            cout<<" passanger name is:"<<al[i].Flight_name<<endl;
            cout<<" passanger name is:"<<al[i].pasanger_name<<endl;
            cout<<" Flight Registraton Number i:"<<al[i].nplate<<endl;
            cout<<" Flight current root is:"<<al[i].root<<endl;
            cout<<" Flight seat number is:"<<al[i].seat_num<<endl;
